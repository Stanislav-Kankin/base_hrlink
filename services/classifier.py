...
1.8 Обращения в службу заботы о клиентах (Этот файл содержит
 справочную информацию и инструкции по настройке и использованию
   различных функций HRlink: интеграции с Битрикс24, выгрузке архивов
     КЭДО, настройке ролей, создание гибких маршрутов заявлений или документов
...
13.1 обновления программ Start Link и HRlink,
которые улучшают автоматизацию и управление кадровыми процессами.
Раскрываются вопросы интеграции с 1С, лицензирования, проверки данных,
а также новые функции мобильных приложений и уведомлений для повышения
эффективности работы с документами.Автоматическая передача данных документов из Start Link в 1С
Иностранный паспорт
