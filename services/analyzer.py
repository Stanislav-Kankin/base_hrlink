...
async def get_answer(question: str) -> str:
    ...
    try:
        ...
        system_prompt = f"""Ты помощник компании HRlink.
          ...
          Если вопрос не относится к HRlink, StartLink, КЕДО 
          мягко сообщи что ты отвечашь только в рамках технических вопросов по HRlink.
...
{knowledge}"""
        ...
        return answer, section if answer else (
        ...
        return (
            ...
            "Пожалуйста, повторите попытку позже или обратитесь в поддержку.", None
            )
